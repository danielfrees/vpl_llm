...
controversial_contexts=False

# Generate Pets dataset
 python -m hidden_context.data_utils.generate_simple_data --output_dir data/simple_pets_balanced/ \
 --data_path data/relabeled_hh_rlhf --with_embeddings True --add_controversial ${controversial_contexts} --synthetic_dataset True \
